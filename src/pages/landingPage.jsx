...
function ProductSkeleton() {
    return (
        <div className="min-w-[260px] max-w-[260px] rounded-3xl bg-white border border-primary/10 shadow-sm overflow-hidden animate-pulse">
            <div className="h-[220px] bg-accent" />
            <div className="p-4">
                <div className="h-4 w-20 bg-accent rounded mb-3" />
                <div className="h-5 w-full bg-accent rounded mb-2" />
                <div className="h-5 w-3/4 bg-accent rounded mb-4" />
                <div className="h-6 w-24 bg-accent rounded mb-4" />
                <div className="h-10 w-full bg-accent rounded-xl" />
            </div>
        </div>
    );
}
...
function ProductSlideCard({ product }) {
    ...
    return (
        <div className="min-w-[260px] max-w-[260px] snap-start rounded-3xl bg-white border border-primary/10 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
            <div className="relative h-[220px] bg-gradient-to-br from-accent to-white flex items-center justify-center overflow-hidden">
                {discount > 0 && (
                    <div className="absolute left-3 top-3 z-10 rounded-full bg-secondary text-white text-xs font-bold px-3 py-1 shadow">
                        Save {discount}%
                    </div>
                )}
            ...
            <div className="p-4">
                ...
                <h3 className="text-primary font-bold text-base leading-6 line-clamp-2 min-h-[48px]">
                ...
                <div className="mt-4 flex gap-2">
                    <Link
                        ...
                        className="flex-1 h-[44px] rounded-xl bg-secondary text-white flex items-center justify-center font-semibold hover:opacity-90 transition"
                    >
                        View
                    </Link>
                    <Link
                        to={`/overview/${product?.productId}`}
                        className="flex-1 h-[44px] rounded-xl border border-secondary text-secondary flex items-center justify-center font-semibold hover:bg-secondary hover:text-white transition"
                    >
                        Buy Now
                    </Link>
                </div>
        ...
        <section className="w-full">
            <div className="flex items-end justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-primary/70 mt-2">{subtitle}</p>
                </div>

                <div className="hidden md:flex items-center gap-3">
                    <button
                        onClick={() => scrollRail("left")}
                        className="w-11 h-11 rounded-full border border-primary/15 bg-white text-primary flex items-center justify-center hover:bg-primary hover:text-accent transition"
                    >
...
function CategoryCard({ icon, title, desc }) {
    return (
        <div className="rounded-3xl bg-white border border-primary/10 p-6 shadow-sm hover:shadow-lg transition">
            <div className="w-14 h-14 rounded-2xl bg-accent flex items-center justify-center text-secondary mb-4">
                {icon}
            </div>
            <h3 className="text-primary text-lg font-bold">{title}</h3>
            <p className="text-primary/70 mt-2 text-sm leading-6">{desc}</p>
        </div>
    );
}
        ...
        <div className="w-full min-h-screen bg-accent">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        <div>
                            ...
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight text-white">
                                Power Up Your
                                <span className="block text-accent">Digital Lifestyle</span>
                            </h1>
                            ...
                            <div className="mt-8 flex flex-wrap gap-4">
                                <Link
                                    to="/products"
                                    className="h-[52px] px-7 rounded-2xl bg-accent text-primary font-bold flex items-center justify-center hover:bg-white transition"
                                >
                                    Shop Now
                                </Link>
                                <Link
                                    to="/about"
                                    className="h-[52px] px-7 rounded-2xl border border-white/25 text-white font-bold flex items-center justify-center hover:bg-white hover:text-primary transition"
                                >
                                    Learn More
                                </Link>
                            </div>
                            ...
                            <div className="relative rounded-[32px] border border-white/15 bg-white/10 backdrop-blur-xl p-5 shadow-2xl">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="rounded-3xl bg-white p-5 shadow-sm">
                                        <p className="text-primary/60 text-sm">Available Products</p>
                                    ...
                                    <div className="rounded-3xl bg-white p-5 shadow-sm">
                                        <p className="text-primary/60 text-sm">Best Value Deals</p>
                                        <h3 className="text-3xl font-black text-primary mt-2">
                                    ...
                                    <div className="col-span-2 rounded-3xl bg-white p-5 shadow-sm">
                                        <div className="flex flex-col sm:flex-row items-center gap-5">
                                            <div className="w-full sm:w-[220px] h-[180px] rounded-3xl bg-accent flex items-center justify-center overflow-hidden">
                                                <img
                                                    src={
                                            ...
                                            <div className="flex-1 w-full">
                                                ...
                                                <h3 className="text-primary text-2xl font-black mt-2">
                                                    {featuredProducts?.[0]?.name ||
                                                        "Top quality computer products"}
                                                </h3>
                                                <p className="text-primary/65 mt-3 leading-7">
                                                ...
                                                <div className="mt-4">
                                                    <Link
                                                        to="/products"
                                                        className="inline-flex h-[46px] px-6 rounded-xl bg-secondary text-white font-bold items-center justify-center hover:opacity-90 transition"
                                                    >
                                                        Explore Products
                                                    </Link>
                                                </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
                <div className="text-center max-w-2xl mx-auto mb-10">
                    ...
                    <p className="text-primary/70 mt-4 leading-7">
                        Browse computers, parts, and accessories in a cleaner shopping layout.
                    </p>
                </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
                <ProductRail
                    title="Best Deals"
                    subtitle="Products with better price gaps are highlighted here."
                    products={dealProducts}
                />
            </section>

            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
                <div className="rounded-[36px] bg-gradient-to-r from-secondary to-primary p-8 lg:p-12 shadow-xl">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="flex lg:justify-end">
                            <Link
                                to="/products"
                                className="h-[54px] px-8 rounded-2xl bg-white text-primary font-black flex items-center justify-center hover:bg-accent transition"
                            >
                                Browse All Products
                            </Link>
                        </div>
